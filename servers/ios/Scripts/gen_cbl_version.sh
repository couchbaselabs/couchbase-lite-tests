...
CBL_VERSION=`/usr/libexec/PlistBuddy read ${CBL_INFO_PLIST_FILE} CFBundleShortVersionString`
CBL_BUILD=`/usr/libexec/PlistBuddy read ${CBL_INFO_PLIST_FILE} CFBundleVersion`
