...
1. Configure Sync Gateway with log redaction enabled
2. Create user 'vipul' with access to channels
3. Create 10 docs via Sync Gateway
4. Verify docs were created (public API)
5. Fetch and scan SG logs for redaction violations
...
1. Configure Sync Gateway
2. Create user 'vipul' with access to ['logging']
3. Create 10 docs via Sync Gateway
4. Start SGCollect via REST API and wait for it to complete
5. Download and extract SGCollect redacted zip
6. Verify redacted zip marks sensitive data with <ud> tags
