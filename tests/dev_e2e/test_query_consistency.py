...
class TestQueryConsistency(CBLTestClass):
    ...
    async def setup_method_fixture(
        ...
        dbs = await testserver.create_and_reset_db(["db1"], dataset="travel")
    ...
    async def _test_query(
        ...
        remote_results = couchbase_server.run_query(
    ...
    async def test_query_docids(self, cloud: CouchbaseCloud):
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_any_operator(self, cloud: CouchbaseCloud):
        # This is annoying because the sort algorithm is different between server and lite
        def id_sort(x: dict):
            return x["id"]
    ...
    async def test_select_star(self, cloud: CouchbaseCloud, doc_id: str):
        await self._test_query(
            cloud.couchbase_server,
    ...
    async def test_limit_offset(self, cloud: CouchbaseCloud, limit: int, offset: int):
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_query_where_and_or(self, cloud: CouchbaseCloud):
        # This is annoying because the sort algorithm is different between server and lite
        def id_sort(x: dict):
            return x["id"]
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_multiple_selects(self, cloud: CouchbaseCloud):
        # This is annoying because the sort algorithm is different between server and lite
        def id_sort(x: dict):
            return x["id"]
    ...
    async def test_query_pattern_like(self, cloud: CouchbaseCloud, like_val: str):
        # This is annoying because the sort algorithm is different between server and lite
        def id_sort(x: dict):
            return x["id"]
    ...
    async def test_query_pattern_regex(self, cloud: CouchbaseCloud, regex: str):
        # This is annoying because the sort algorithm is different between server and lite
        def id_sort(x: dict):
            return x["id"]
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_query_is_not_valued(self, cloud: CouchbaseCloud):
        await self._test_query(
            cloud.couchbase_server,
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_query_ordering(self, cloud: CouchbaseCloud):
        await self._test_query(
            cloud.couchbase_server,
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_query_substring(self, cloud: CouchbaseCloud):
        await self._test_query(
            cloud.couchbase_server,
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_query_join(self, cloud: CouchbaseCloud):
        ...
        await self._test_join(cloud.couchbase_server, query, server_query)

    @pytest.mark.asyncio(loop_scope="session")
    async def test_query_inner_join(self, cloud: CouchbaseCloud):
        query = """
        ...
        await self._test_join(cloud.couchbase_server, query)
    ...
    async def test_query_left_join(self, cloud: CouchbaseCloud, server_join_type: str):
        query = """
    ...
    async def test_equality(self, cloud: CouchbaseCloud, operation: str):
        await self._test_query(
            cloud.couchbase_server,
    ...
    async def test_comparison(self, cloud: CouchbaseCloud, operation: str):
        await self._test_query(
            cloud.couchbase_server,
    ...
    @pytest.mark.asyncio(loop_scope="session")
    async def test_in(self, cloud: CouchbaseCloud):
        await self._test_query(
            cloud.couchbase_server,
    ...
    async def test_between(self, cloud: CouchbaseCloud, keyword: str):
        await self._test_query(
            cloud.couchbase_server,
    ...
    async def test_same(self, cloud: CouchbaseCloud, keyword: str):
        await self._test_query(
            cloud.couchbase_server,
