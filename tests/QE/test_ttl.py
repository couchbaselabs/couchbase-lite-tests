...
class TestTTL(CBLTestClass):
    ...
    async def test_document_expiry_unix_timestamp(
        ...
        doc_exp_3 = await sg.get_document(sg_db, "exp_3", "_default", "_default")
        doc_exp_years = await sg.get_document(
        ...
        try:
            expired_doc = await sg.get_document(sg_db, "exp_3", "_default", "_default")
        ...
        doc_still_valid = await sg.get_document(
            sg_db, "exp_years", "_default", "_default"
        )
