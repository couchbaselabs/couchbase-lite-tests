...
class TestBasicReplication(CBLTestClass):
    ...
    async def test_continuous_push(self, cblpytest: CBLPyTest, dataset_path: Path) -> None:
        ...
        await replicator.wait_for_all_doc_events({
            WaitForDocumentEventEntry("travel.airports", "test_airport_1", ReplicatorType.PUSH,
                                      ReplicatorDocumentFlags.NONE),
            WaitForDocumentEventEntry("travel.airports", "test_airport_2", ReplicatorType.PUSH,
                                      ReplicatorDocumentFlags.NONE),
            WaitForDocumentEventEntry("travel.airlines", "airline_1", ReplicatorType.PUSH,
                                      ReplicatorDocumentFlags.NONE),
            WaitForDocumentEventEntry("travel.airlines", "airline_2", ReplicatorType.PUSH,
                                      ReplicatorDocumentFlags.NONE),
    ...
    async def test_continuous_pull(self, cblpytest: CBLPyTest, dataset_path: Path):
        ...
        routes_updates: List[DocumentUpdateEntry] = [
            DocumentUpdateEntry("test_route_1", None, body={
                "airline": "Skyline",
                "channels": ["United States"],
                "country": "United States",
                "sourceairport": "SFO",
                "destinationairport": "NRT"}),
            DocumentUpdateEntry("test_route_2", None, body={
                "airline": "Nimbus",
                "channels": ["United States"],
                "country": "United States",
                "sourceairport": "SFO",
        ...
        self.mark_test_step("Wait until receiving all document replication events")
        await replicator.wait_for_all_doc_events({
            WaitForDocumentEventEntry("travel.routes", "test_route_1", ReplicatorType.PULL,
                                      ReplicatorDocumentFlags.NONE),
            WaitForDocumentEventEntry("travel.routes", "test_route_2", ReplicatorType.PULL,
                                      ReplicatorDocumentFlags.NONE),
            WaitForDocumentEventEntry("travel.landmarks", "landmark_100", ReplicatorType.PULL,
                                      ReplicatorDocumentFlags.NONE),
            WaitForDocumentEventEntry("travel.landmarks", "landmark_200", ReplicatorType.PULL,
                                      ReplicatorDocumentFlags.NONE),
            WaitForDocumentEventEntry("travel.hotels", "hotel_400", ReplicatorType.PULL,
                                      ReplicatorDocumentFlags.DELETED),
            WaitForDocumentEventEntry("travel.hotels", "hotel_500", ReplicatorType.PULL,
                                      ReplicatorDocumentFlags.DELETED)
        })
