...
def download_sgw_package(version: str, build: int) -> str:
    local_filename = SCRIPT_DIR / f"couchbase-sync-gateway-enterprise_{version}-{build}_x86_64.rpm"
...
def main(hostnames: List[str], version: str, build: int, private_key: Optional[str] = None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--version", default="4.0.0", help="The version of Sync Gateway to install.")
    parser.add_argument("--build", default=-1, type=int, help="The build number of Sync Gateway to install (latest good by default)")
