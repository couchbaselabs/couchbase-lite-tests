...
SG_CONFIG_TEMPLATE_PATH = (
    "environment/sg/config/bootstrap-config.json"  # Sync Gateway config template
)
UPDATED_SG_CONFIG_PATH = (
    "environment/sg/config/bootstrap-config.json"  # Updated Sync Gateway config
)
