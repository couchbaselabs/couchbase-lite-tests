...
parser = argparse.ArgumentParser(description="Update Edge Server config with cluster IP.")
parser.add_argument('--es-config', required=True, help='Path to the Sync Gateway config template JSON file')
