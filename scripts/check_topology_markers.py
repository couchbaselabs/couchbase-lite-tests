...
# Helpers that touch topology lists without requiring anything of them: they act on
# whatever the environment happens to provide and no-op when it provides nothing.
# Tracing into them would demand a min_* marker from every test that cleans up, which
# is the opposite of what the marker means.
